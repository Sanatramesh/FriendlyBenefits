...
public class DisplayFav extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tag_string_req = "req_owed";
                ...
                try {
                    ...
                    else
                    {
                        ...
                        for(int i=0;i<favour.length();i++) {
                            ...
                            listAdapter.add(favour.getJSONObject(i).getJSONObject("record").getString("uname1") + "  |  " + favour.getJSONObject(i).getJSONObject("record").getString("description"));
                        }
                        //Toast.makeText(getApplicationContext(),
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                ...
                try {
                    ...
                    final String uname1=jchoice.getJSONObject("record").getString("uname1");
                    final String email1=jchoice.getJSONObject("record").getString("email1");
                        ...
                        .withEndAction(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(status.equalsIgnoreCase("Accepted")){
                                    Intent intent = new Intent(DisplayFav.this,
                                            DispIndFav1.class);
